        ...
        <el-menu mode="horizontal">
          ...
          <el-menu-item>
            ...
            <div class="heavy-examine border-content">
              <el-checkbox-group v-model="fhour" class="heavy-examine-group">
                <el-checkbox label="before">0~6小时</el-checkbox>
                <el-checkbox label="after">6~12小时</el-checkbox>
              </el-checkbox-group>
            </div>
          </el-menu-item>
        </el-menu>
...
<script>
import RainProgress from "../../zhongduan/provincial/RainProgress";
